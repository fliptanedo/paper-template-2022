...
% \usepackage{mleftright}     % \mleft and \mright
...
% \usepackage{framed}			% boxed remarks / better: mdframed 
% \usepackage{mdframed}   % replace framed
% \usepackage{tcolorbox}  % replace mdframed
\usepackage[most]{tcolorbox} % `most' needed for listings
\usepackage{subcaption}	% subfigures
\usepackage{cite}			  % group cites
% \usepackage{xspace}			% macro spacing %% depreciated
\usepackage{wrapfig}    
