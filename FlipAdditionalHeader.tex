...
\newcommand{\test}{\emph{test}\xspace}      % nb: I do not like using this
\newcommand{\testt}{test\xspace}      % nb: I do not like using this
\newcommand{\testtt}{{test}\xspace}      % nb: I do not like using this
\newcommand{\ddm}{\acro{DM}}
