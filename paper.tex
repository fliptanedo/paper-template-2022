...
\input{FlipAdditionalHeader} 	%% additional macros
% \input{FlipAdditionalHeader_listings} %% for code blocks
...
% I should have a bit about style
%   Didier Verna, ``Towards LATEX coding standards''
%     https://tug.org/TUGboat/tb32-3/tb102verna.pdf
%     https://medium.com/@pbeliveau/latex-coding-standards-f82743b7866b
%     http://zeeba.tv/toward-latex-coding-standards/
%   Evan Chen's guide
