...
\end{align}
\end{subequations}
where we can now refer to the pair of equations \eqref{eq:subequations} or simply one of the equations, \eqref{eq:subequation:2}.
...
% \begin{align}
% 	\left(\frac{R}{z}\right)^d\\
% 	{\mleft(\frac{R}{z}\mright)}^{\!\!d}
% \end{align}
